<template>
<router-link style="text-decoration: none; color: inherit;" :to="{ name: 'dan-modal', params: { userprop: user, username: user.name } }">
    <div class="dan-card" @mouseenter="hoverCard=true" @mouseleave="hoverCard=false">
